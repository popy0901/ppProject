	...
	namespace Class
	{
		...
		private:
			...
			struct CbSubset
			{
				...
				DirectX::XMFLOAT4	LightColor;		//ÉâÉCÉgÇÃêF
				DirectX::XMFLOAT4	AmbientColor;	//ä¬ã´åı
				DirectX::XMFLOAT4	EyePos;			//ÉJÉÅÉâ
				DirectX::XMFLOAT4	Paramter;		// x = îjâÛÉåÅ[Ég, y = ägèkåWêî, z = âÒì]åWêî, w = à⁄ìÆåWêî)
			};
