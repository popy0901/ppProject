...
// CEREALバージョン定義
CEREAL_CLASS_VERSION(PP::Class::ModelResource::Node, 1)
CEREAL_CLASS_VERSION(PP::Class::ModelResource::Material, 1)
CEREAL_CLASS_VERSION(PP::Class::ModelResource::Subset, 1)
CEREAL_CLASS_VERSION(PP::Class::ModelResource::Vertex, 1)
CEREAL_CLASS_VERSION(PP::Class::ModelResource::Mesh, 1)
CEREAL_CLASS_VERSION(PP::Class::ModelResource::NodeKeyData, 1)
CEREAL_CLASS_VERSION(PP::Class::ModelResource::Keyframe, 1)
CEREAL_CLASS_VERSION(PP::Class::ModelResource::Animation, 1)
CEREAL_CLASS_VERSION(PP::Class::ModelResource, 1)
