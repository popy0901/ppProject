...
namespace PP
{
	namespace Class
	{
		...
		void LineRenderer::DrawLine(const DirectX::XMFLOAT3& pos1, const DirectX::XMFLOAT3& pos2, const DirectX::XMFLOAT4& color)
		{
			AddVertex(pos1, color);
			AddVertex(pos2, color);
		}

		void LineRenderer::DrawCube(const DirectX::XMFLOAT3& pos1, const DirectX::XMFLOAT3& pos2, const DirectX::XMFLOAT4& color)
		{
			DrawLine(pos1, { pos2.x, pos1.y, pos1.z }, color);
			DrawLine(pos1, { pos1.x, pos2.y, pos1.z }, color);
			DrawLine(pos1, { pos1.x, pos1.y, pos2.z }, color);

			DrawLine({ pos1.x, pos2.y, pos1.z }, { pos2.x, pos2.y, pos1.z }, color);
			DrawLine({ pos1.x, pos2.y, pos1.z }, { pos1.x, pos2.y, pos2.z }, color);

			DrawLine({ pos1.x, pos1.y, pos2.z }, { pos2.x, pos1.y, pos2.z }, color);
			DrawLine({ pos1.x, pos1.y, pos2.z }, { pos1.x, pos2.y, pos2.z }, color);

			DrawLine({ pos2.x, pos1.y, pos1.z }, { pos2.x, pos2.y, pos1.z }, color);
			DrawLine({ pos2.x, pos1.y, pos1.z }, { pos2.x, pos1.y, pos2.z }, color);

			DrawLine(pos2, { pos1.x, pos2.y, pos2.z }, color);
			DrawLine(pos2, { pos2.x, pos1.y, pos2.z }, color);
			DrawLine(pos2, { pos2.x, pos2.y, pos1.z }, color);
		}
	}
}